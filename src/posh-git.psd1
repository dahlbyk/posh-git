...
PrivateData = @{
    PSData = @{
        ...
        LicenseUri = 'https://github.com/dahlbyk/posh-git/blob/v1.0.0-beta5/LICENSE.txt'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/dahlbyk/posh-git'

        # ReleaseNotes of this module
        ReleaseNotes = 'https://github.com/dahlbyk/posh-git/blob/v1.0.0-beta5/CHANGELOG.md'
